...
namespace lingvo.postagger
{
    ...
    public sealed class ProcessHandler : IHttpHandler
    {
        ...
        public struct morpho_info
        {
            ...
            [JsonProperty(PropertyName="nf")]  public string normalForm      { get; }
            [JsonProperty(PropertyName="pos")] public string partOfSpeech    { get; }
            [JsonProperty(PropertyName="ma")]  public string morphoAttribute { get; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        private static class ConcurrentFactoryHelper
        {
            private static PosTaggerProcessorConfig      CreatePosTaggerProcessorConfig()
            {
                ...
                var config = new PosTaggerProcessorConfig( Config.TOKENIZER_RESOURCES_XML_FILENAME, Config.POSTAGGER_RESOURCES_XML_FILENAME, LanguageTypeEnum.En, sentSplitterConfig )
                {
        ...
        private static void SendJsonResponse( HttpContext context, Exception ex ) => SendJsonResponse( context, new result_json_by_sent( ex ) );
